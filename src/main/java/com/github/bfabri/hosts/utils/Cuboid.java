...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public Cuboid(Map<String, Object> map) {
        ...
        this.x1 = ((Double) map.get("x1")).intValue();
        this.x2 = ((Double) map.get("x2")).intValue();
        this.y1 = ((Double) map.get("y1")).intValue();
        this.y2 = ((Double) map.get("y2")).intValue();
        this.z1 = ((Double) map.get("z1")).intValue();
        this.z2 = ((Double) map.get("z2")).intValue();
    }
    ...
    public Location getCenter(int changeY) {
        ...
        return new Location(this.getWorld(), this.getLowerX() + (x1 - this.getLowerX()) / 2.0, this.getLowerY() + changeY, this.getLowerZ() + (z1 - this.getLowerZ()) / 2.0);
    }
